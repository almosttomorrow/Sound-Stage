...
export const VENUES = [
  {
    ...
    note: 'The reference. Almost no room at all — close to what the mix engineer heard.',
    system: 'monitors',
    dims: [6.5, 4.8, 3.0],
  ...
  },
  {
    ...
    note: 'Plaster and wood, a full house, and the long smooth reverb these halls are built for.',
    system: 'hallRig',
    dims: [45, 22, 17],
  ...
  },
  {
    ...
    note: 'Four seconds of reverb that gets warmer as it fades, and speakers aimed tightly enough that the music stays clear inside it.',
    system: 'columnPA',
    dims: [30, 14, 15],
    materials: { xMin: 'woodPanel', xMax: 'stone', yMin: 'stainedGlass', yMax: 'plaster', floor: 'naveSeating', ceiling: 'plaster' },
    listener: [17, 7, 1.3],
    spot: 'Ten rows back, 10 m from the speakers',
  ...
  },
  {
    ...
    note: 'Huge subs, a treated ceiling, a floor full of people. Tight enough that the kick hits, big enough to feel.',
    system: 'soundSystem',
    dims: [24, 16, 5.5],
    materials: { xMin: 'audience', xMax: 'concrete', yMin: 'concrete', yMax: 'brick', floor: 'clubFloor', ceiling: 'clubCeiling' },
    listener: [13, 8, 1.6],
    spot: 'On the dance floor, 9 m from the speakers',
  ...
  },
  {
    ...
    note: 'Sixty-seven metres of open air between you and the speakers, with the treble boosted to survive the trip.',
    system: 'lineArray',
    dims: [190, 140, 38],
    materials: { xMin: 'audience', xMax: 'audience', yMin: 'audience', yMax: 'audience', floor: 'grass', ceiling: 'openSky' },
    listener: [95, 70, 2],
    spot: 'Middle of the crowd, 67 m from the speakers',
  ...
  },
  {
    ...
    name: 'Car',
    place: 'Saloon cabin',
    note: 'Door speakers a foot from one ear and three from the other. Tuned as well as a car allows — but nothing is centred.',
    system: 'carDoors',
    dims: [2.4, 1.6, 1.15],
